...
PRINT:
		 ...
		 MOVE.W 	14(A6),D3			*D1=TAMA—O
		 								*creo marco de pila
*		 CMP.W		#0,D1				*SI TAMA—O = 0 --> DESTRUCCION DEL MARCO DE PILA
*		 BEQ		DMPILA
...
SCANB: 	 
		 ...
		 MOVE.L 	#1,D0 				*D0=0
		 BSR 		LINEA 				*llamo a linea para saber cual es el tamaÒo DE linea
		 MOVE.L 	D0,D2				*D2=LINEA
		 MOVE.L 	D2,D3				*D3 REGISTRO POR SI ACASO CON N
		 CMP.W		#0,D2 				*LINEA=0?
		 BEQ 		FINCEROB
...
TAMEP:      DC.W        0           *Tama√±o de escritura para PRINT
DESAP:      EQU         0          *Descriptor de linea A
DESBP:      EQU         1          *Descriptor de linea B 
NLINP:      EQU         1           *Numero de lineas a leer
TAMLP:      EQU         30           *Tama√±o de linea para SCAN
TAMBP:      EQU         30           *Tama√±o de bloque para PRINT
...
OTRAL:      MOVE.W      #TAMLP,-(A7)     *Tama√±o maximo de la linea
...
ESPL:       BSR         SCAN
            ...
            MOVE.L      #BUFP,DIRLECP     *Direccion de lectura (comienzo del buffer)
OTRAE:      MOVE.W      #TAMBP,TAMEP     *Tama√±o de escritura = Tama√±o de bloque
ESPE:       MOVE.W      TAMEP,-(A7)     *Tama√±o de escritura
            ...
            SUB.W       D0,TAMEP       *Actualiza el tama√±o de escritura
            BNE         ESPE         *Si no se ha escrito todo el bloque se insiste
            CMP.W       #TAMBP,CONTCP     *Si el n¬∫ de caracteres que quedan es menor que el 
                            *tama√±o establecido se transimite ese numero
